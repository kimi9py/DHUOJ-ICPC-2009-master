...
public class RunBean {
    ...
    private List<SpecialJudgeBean> specialJudgeList;
    ...
    public List<SpecialJudgeBean> getSpecialJudgeList() {
        return specialJudgeList;
    }
    
    public void setSpecialJudgeList(List specialJudgeList) {
        this.specialJudgeList = specialJudgeList;
    }
