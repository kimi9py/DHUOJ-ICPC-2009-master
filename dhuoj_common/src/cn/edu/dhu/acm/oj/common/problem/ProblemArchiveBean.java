...
public final class ProblemArchiveBean extends NodeBean {
    ...
    public int getSpecialJudgeCount() {
        return root.getChildrenCount("SpecialJudge");
    }

    public List getSpecialJudgeList() {
        return root.getChildren("SpecialJudge");
    }
    
    public void removeSpecialJudge(int index) {
        root.removeChild("SpecialJudge", index);
    }
    
    public SpecialJudgeBean getSpecialJudge(int i) {
        Element element = super.root.getChild("SpecialJudge", i);
        SpecialJudgeBean specialJudge = new SpecialJudgeBean(element);
        return specialJudge;
    }
    ...
    private static final String SOFTWARE_VERSION = "1.2";
