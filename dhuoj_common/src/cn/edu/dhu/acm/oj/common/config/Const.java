...
public class Const {
	...
	public static final Class[] QUESTIONTABLECOLTYPE = {Integer.class, String.class, String.class};
        public static final String[] NOTIFICATIONTABLECOLNAME = {"ID", "Time", "Notification"};
        public static final Class[] NOTIFICATIONTABLECOLTYPE = {Integer.class, String.class, String.class};
	...
	public static final long QUERYINITTIME = 10000;
	/**The Time status reflash*/
	public static final long CLIENTSTATUSTIME = 5000;
	...
	public static final long SUBMITSLEEP = 1000;
	/**Output File Size*/
	public static final long FILEMAXSIZE = 5L << 20;
	/**Compile Name*/
	public static final String COMPILENAME = "Main";
        public static final String SPJCOMPILENAME = "SpecialJudge";
        public static final String USEROUTPUTFILENAME = "test.user";
        public static final String INPUTDATAFILENAME = "test.in";
        public static final String OUTPUTDATAFILENAME = "test.out";
