...
public class CodePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        JB_LoadSample = new javax.swing.JButton();
        ...
        JB_RunTest.setText("Compile & Run Test");
        ...
        JB_LoadSample.setText("Load Sample");
        JB_LoadSample.setToolTipText("Load Sample");
        JB_LoadSample.setFocusable(false);
        JB_LoadSample.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        JB_LoadSample.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        JB_LoadSample.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JB_LoadSampleActionPerformed(evt);
            }
        });
        TB_Test.add(JB_LoadSample);
        ...
        jLabel1.setText("Time Limit(sec) : ");
        TB_Test.add(jLabel1);
        ...
        JTP_Info.addTab("Compile Information", JP_CompileInfo);
...
private void JB_SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SubmitActionPerformed
    ...
    private void JB_RunTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_RunTestActionPerformed
        try {
            JTA_Out.setText("Running ...");  // in order to tell user the output is refreshed
            Save();
            JTA_CompileInfo.setText("Compiling~~~");
            final long tl = Long.parseLong(TF_Time.getText());
    ...
    private void JB_PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_PrintActionPerformed
		...
		tmp.setTabSize(4);
		tmp.setFont(new java.awt.Font("Courier New", 0, 8));
    ...
    private void JB_LoadSampleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_LoadSampleActionPerformed
        TF_Time.setText(String.valueOf(Control.getPaperBean().getProblemAt(Control.getNowProblemNum()).getTestData().getTimeLimit()));
        JTA_In.setText(Control.getPaperBean().getProblemAt(Control.getNowProblemNum()).getTestData().getSampleInput());
        JTA_Out.setText("");
    }//GEN-LAST:event_JB_LoadSampleActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton JB_Clear;
    private javax.swing.JButton JB_Compile;
    private javax.swing.JButton JB_LoadSample;
