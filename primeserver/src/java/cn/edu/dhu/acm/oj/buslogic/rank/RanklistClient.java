...
//        }
    ...
    private void printHeader(PrintWriter os) {
        ...
        os.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">");
        os.println("<link type=\"text/css\" href=\"../css/ranklist.css\" rel=\"stylesheet\">");
        os.println("</head>");
        os.println("<body>");
        os.print("<div align='center'>");
        os.println("<h1>" + contest.getTitle() + "</h1>");
        os.println("<h4>contest time: " + format.format(contest.getStartTime()) + " ----- " + format.format(contest.getEndTime()) + "</h4>");
        os.println("<h4>last update: " + Util.getTimeString() + "</h4>");

        os.println("<table id=\"maintable\" class=\"border-table\">");
        os.print("<tr>");
        os.print("<th class=\"border-th\"><strong><u>Rank</u></strong></th>");
        os.print("<th class=\"border-th\"><strong><u>Name</u></strong></th>");
        os.print("<th class=\"border-th\"><strong><u>School</u></strong></th>");
        os.print("<th class=\"border-th\"><strong><u>Solved</u></strong></th>");
        os.print("<th class=\"border-th\"><strong><u>Time</u></strong></th>");
        String alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        for (int j = 0; j < this.numProblems; ++j) {
            os.print("<th class=\"border-th\">&#160;&#160;&#160;&#160;<strong><u>" + alphabet.charAt(j % 26) + "</u></strong>&#160;&#160;&#160;&#160;</th>");
        }
        os.print("<th class=\"border-th\"><strong><u>Total att/solv</strong></th>");
        os.print("</tr>");
        os.println();
    }
    ...
    private void printRow(PrintWriter os, ClientScoreData csd) {
        ...
        if (csd == null) {
            ...
            os.print("<tr>");
            os.print("<td class=\"border-td\" align='center'>" + csd.getRank() + "</td>");
            os.print("<td class=\"border-td\" align='center'>" + name + "</td>");
            os.print("<td class=\"border-td\" align='center'>" + school + "</td>");
            os.print("<td class=\"border-td\" align='center'>" + csd.getNumberOfSolvedProblems() + "</td>");
            os.print("<td class=\"border-td\" align='center'>" + (csd.getScore() / 60000L) + "</td>");
            String stats = "";
            ...
            for (int j = 1; j <= this.numProblems; ++j) {
                ...
                os.print("<td class=\"border-td\" align='center'>" + stats + "</td>");
            }

            os.print("<td class=\"border-td\" align='center'>" + attempts + "/" + solved + "</td>");
            os.print("</tr>");
            os.println();
        }
    }
    ...
    private void printTrailer(PrintWriter os) {
        ...
        os.println("</table>");
        os.println("<br>");
        os.println("<table id=\"tablelegend\" align=\"center\">\n" +
"					<tr>\n" +
"						<td class=\"firstac\">First to solve</td>\n" +
"						<td class=\"ac\">Solved</td>\n" +
"						<td class=\"fail\">Attempted</td>\n" +
"					</tr>\n" +
"				</table>\n" +
"				<p>&nbsp;</p> ");
        os.println("</div>");
        os.println("<script type=\"text/javascript\" src=\"../js/ranklist.js\"></script>");
        os.println("</body>");
        os.println("</html>");
    }
    ...
    private void summarizePSD(PrintWriter os) {
        ...
        line.append("<tr>");
        line.append("<td class=\"border-td\">Summary</td>");
        line.append("<td class=\"border-td\">Submitted/Total Yes</td>");
        line.append("<td class=\"border-td\" /><td class=\"border-td\"/><td class=\"border-td\"/>");
        ...
        for (int p = 1; p <= this.numProblems; ++p) {
            ...
            line.append("<td class=\"border-td\" align='center'>" + this.psdAttempts[p] + "/" + this.psdAccepted[p] + "</td>");
        }
        line.append("<td class=\"border-td\" align='center'>" + totalAttempts + "/" + totalAccepted + "</td>");
        line.append("</tr>");
        os.println(line);
    }
}