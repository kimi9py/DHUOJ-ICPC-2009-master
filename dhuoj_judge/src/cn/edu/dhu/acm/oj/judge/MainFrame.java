...
import cn.edu.dhu.acm.oj.judge.file.FileWorker;
...
public class MainFrame extends javax.swing.JFrame {
	...
	public MainFrame()  {
		...
		initComponents();
                String temp = fileworker.readTxtFile();
                if(!temp.equals("-1")){
                    Control.setIP(temp);
                    Control.getApplyFrame().setTF_ServerIp(temp);
	...
	public void setMessageQueue(int size, boolean isNew) {
            JT_MessageQueue.setText("" + size);
            if (isNew) {
                smallDialog("New message received!", "Info", 0);
            }
	}
	...
	public void setSolutionGotten() {
        ...
        public void exitAutoJudge() {
            ...
            smallDialog("Auto Special Judge Failed!\nPlease review the solution!", "Error", 0);
        }

        public void smallDialog(final String str, final String title, int model) {
            new Thread() {
                public void run() {
                    JOptionPane.showMessageDialog(MainFrame.this, str, title, JOptionPane.INFORMATION_MESSAGE);
                }
            }.start();
        }
